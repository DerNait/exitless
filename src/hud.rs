...
use crate::renderer::{render_minimap, MinimapColors};
use crate::maze::Maze;
use crate::player::Player;
use crate::enemy::Enemy;

/// HUD de 150px, textura de fondo 'h', cara 'f' centrada y mini-mapa con rayos de visión.
pub struct Hud {
    pub height: i32,          // px
...
impl Hud {
    ...
    pub fn render(
        ...
        // 3) Mini-mapa con rayos de visión (esquina inferior izquierda)
        let pad = 12;
        ...
        render_minimap(
            fb, maze, player, enemies, block_size,
            mm_x, mm_y, mm_w, mm_h,
            &self.minimap_style,
        );
    }
